...
### Added
- Select component `labelPosition` prop ("top" | "left"), default "left", for label placement
- `SelectLabelPosition` type export

## [3.5.11] - 2026-02-05

### Added
- Tab and TabItem component updates (documentation and playground)
...
### Fixed
- Added missing typography utility classes `.text-title-medium` and `.text-title-large` to beacon-ui package
- All four title typography classes (small, regular, medium, large) are now available in the package

## [3.5.7] - 2026-01-17

### Added
- Added `CornerRadiusToken` type export for TypeScript support
- All corner radius tokens (25, 50, 100, 200, 300, 400, 450, 500, 550, 600, none, full) are now available as CSS variables
- Corner radius tokens 500, 550, and 600 are now accessible for use in custom CSS

### Changed
- Updated token build script to automatically generate `CornerRadiusToken` type from design tokens

## [3.5.6] - 2026-01-16

### Changed
- Updated version synchronization and documentation
